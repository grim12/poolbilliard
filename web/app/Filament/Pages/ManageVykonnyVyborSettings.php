...
class ManageVykonnyVyborSettings extends SettingsPage
{
    protected static string $settings = VykonnyVyborSettings::class;

    protected static string|BackedEnum|null $navigationIcon = Heroicon::OutlinedMegaphone;

    protected static ?string $navigationLabel = 'Zprávy výboru';

    protected static string|UnitEnum|null $navigationGroup = 'Stránky';

    protected static ?string $title = 'Nastavení stránky Zprávy výboru';
