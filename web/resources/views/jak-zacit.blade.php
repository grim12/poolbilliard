...
<x-layouts.app
    ...
    :description="\App\Support\Locale::field($settings, 'seo_description') ?: __('Chcete začít hrát poolbilliard? Zjistěte, jak najít klub, přihlásit se k prvnímu turnaji a zorientovat se v soutěžích.')"
